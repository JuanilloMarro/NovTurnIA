...
import { ModalShell, FieldLabel, CentsAmountInput, decimalToCents, centsToDecimal, OptionWheel, NotesField, ModalButtons, useMethodOptions, useFinanceStaff } from './financeUi';
...
export default function ConfirmDeliveryModal({ serviceName, clientName, defaultAmount, onClose, onConfirm }) {
    ...
    const [amountCents, setAmountCents] = useState(decimalToCents(defaultAmount));
