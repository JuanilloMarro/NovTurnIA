...
export default function CalendarWeek({ appointments, weekStart, loading, onEventClick }) {
    ...
    return (
        <div className="bg-white/80 backdrop-blur-card border border-white/90 rounded-2xl shadow-card flex flex-col h-full overflow-hidden">

            {/* Header días */}
            <div className="grid grid-cols-[60px_repeat(7,1fr)] border-b border-gray-100/50 bg-white/30 backdrop-blur-md">
