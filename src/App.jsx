                            ...
                            <div className="h-[100dvh] w-screen relative overflow-hidden bg-transparent safe-area-shell flex items-center justify-center">
                                ...
                                <div className="app-frame w-full max-w-[1920px] h-full rounded-none sm:rounded-[24px] lg:rounded-[32px] bg-white/40 backdrop-blur-xl sm:border sm:border-white/60 shadow-none sm:shadow-[0_20px_50px_rgba(26,58,107,0.05),inset_0_2px_4px_rgba(255,255,255,0.8)] overflow-hidden relative z-10 flex">
                                    ...
                                    {/* T7 · ml-0 mientras el sidebar es cajón, lg:ml-[272px] cuando queda
                                        ...
                                        se llevaba 272px de 768, o sea el 35% de la pantalla, dejando 496px
                                        para el módulo. Este número debe coincidir con el `lg:` del Sidebar,
                                        el del Topbar y la media query de index.css. */}
                                    <div className="flex-1 ml-0 lg:ml-[272px] flex flex-col relative w-full h-full min-w-0">
                                        <Topbar />
                                        {/* El aviso de caída de Realtime se movió al pie del sidebar.
                                            Acá arriba empujaba el módulo entero al aparecer y desaparecer,
                                            así que un parpadeo de conexión hacía saltar toda la pantalla.
                                            Ver RealtimeStatusBanner.jsx y Sidebar.jsx. */}
