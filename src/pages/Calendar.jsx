    ...
    return (
        <div className={`h-full flex flex-col px-2 relative transition-all duration-300`}>
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 mb-4">
                ...
                <div className="flex items-center gap-3 flex-wrap max-lg:flex-nowrap max-lg:[&>*]:shrink-0 w-full lg:w-auto justify-start lg:justify-end overflow-x-auto lg:overflow-visible mobile-strip">
