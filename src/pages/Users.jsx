                ...
                <div className={`${selectedUser ? 'flex' : 'hidden md:flex'} flex-1 flex-col relative min-w-0`}>
                    {selectedUser ? (
                        <div className="flex flex-col h-full overflow-hidden">
                            ...
                            <div className="p-4 sm:p-8 pb-3 shrink-0 z-10 relative animate-fade-down">
                                <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6 xl:gap-0 mb-4">
                                    <div className="flex items-center gap-3 sm:gap-5">
                                        ...
                                        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center text-white text-base sm:text-lg font-bold shadow-md bg-navy-900 shrink-0">
                            ...
                            <div className="flex-1 overflow-y-auto px-4 sm:px-8 py-4 custom-scrollbar relative animate-fade-up">
                            ...
                            {canEditPermissions && (
                                <div className="mt-6 px-4 sm:px-8 pb-6 sm:pb-10 flex items-center justify-end gap-3 z-20">
                                    <button
                                        onClick={async () => {
